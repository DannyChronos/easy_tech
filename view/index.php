...
<body id="page-top">
    <?php require_once("./assets/other/nav.php");?>
    <header class="col-md-12 col-sm-12 masthead" style="background-image:url('assets/img/Pic1-1-1200x640.jpg');">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in" data-aos="fade-left" data-aos-duration="800"><span>Welcome To Our Studio!</span></div>
                <div class="intro-heading text-uppercase"  data-aos="fade-right" data-aos-duration="850"><span>It's Nice To Meet You</span></div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger colors" role="button" data-aos="fade-up" data-aos-duration="900" href="#services">Tell me more</a>
            </div>
        </div>
    </header>
    <section id="services">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4" ><span class="fa-stack fa-4x" data-aos="slide-up" data-aos-duration="800"><i class="fa fa-circle fa-stack-2x text-primary glob"></i><i class="fa fa-shopping-cart fa-stack-1x fa-inverse icon"></i></span>
                    <h4 class="section-heading" data-aos="zoom-in" data-aos-duration="700">E-Commerce</h4>
                    <p class="text-muted" data-aos="zoom-out" data-aos-duration="750">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
                <div class="col-md-4"><span class="fa-stack fa-4x" data-aos="slide-up" data-aos-duration="1000"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-laptop fa-stack-1x fa-inverse"></i></span>
                    <h4 class="section-heading" data-aos="zoom-in" data-aos-duration="900">Responsive Design</h4>
                    <p class="text-muted" data-aos="zoom-out" data-aos-duration="950">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
                <div class="col-md-4"><span class="fa-stack fa-4x" data-aos="slide-up" data-aos-duration="1200"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-lock fa-stack-1x fa-inverse"></i></span>
                    <h4 class="section-heading" data-aos="zoom-in" data-aos-duration="1100">Web Security</h4>
                    <p class="text-muted" data-aos="zoom-out" data-aos-duration="1150">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="portfolio" class="bg-light">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="text-uppercase section-heading" style="color: white;">Portfolio</h2>
                    <h3 class="section-subheading text-muted" style="color: black;">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4 portfolio-item" data-bs-hover-animate="pulse">
                    ...
                    <ul class="list-group timeline">
                        <li class="list-group-item">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading" data-aos="fade-right" data-aos-duration="800">
                                    <h4>2009-2011</h4>
                                    <h4 class="subheading">Our Humble Beginnings</h4>
                                </div>
                                <div class="timeline-body" data-aos="fade-right" data-aos-duration="850">
                        ...
                        <li class="list-group-item timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading" data-aos="fade-left" data-aos-duration="800">
                                    <h4>March 2011</h4>
                                    <h4 class="subheading">An Agency is Born</h4>
                                </div>
                                <div class="timeline-body" data-aos="fade-left" data-aos-duration="850">
                                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                                </div>
                            </div>
                        </li>
    ...
    <section id="team" class="bg-light">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member" data-aos="zoom-out" data-aos-duration="800"><img class="rounded-circle mx-auto" src="assets/img/team/1.jpg">
                        <h4 data-aos="fade-up" data-aos-duration="900">Kay Garland</h4>
                        <p class="text-muted" data-aos="fade-up" data-aos-duration="900">Lead Designer</p>
                        <ul class="list-inline social-buttons" data-aos="zoom-in" data-aos-duration="950">
                ...
                <div class="col-sm-4">
                    <div class="team-member" data-aos="zoom-out" data-aos-duration="800"><img class="rounded-circle mx-auto" src="assets/img/team/2.jpg">
                        <h4 data-aos="fade-up" data-aos-duration="900">Larry Parker</h4>
                        <p class="text-muted" data-aos="fade-up" data-aos-duration="900">Lead Marketer</p>
                        <ul class="list-inline social-buttons" data-aos="zoom-in" data-aos-duration="950">
                            <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fa fa-linkedin"></i></a></li>
                ...
                <div class="col-sm-4">
                    <div class="team-member" data-aos="zoom-out" data-aos-duration="800"><img class="rounded-circle mx-auto" src="assets/img/team/3.jpg">
                        <h4 data-aos="fade-up" data-aos-duration="900">Diana Pertersen</h4>
                        <p class="text-muted" data-aos="fade-up" data-aos-duration="900">Lead Developer</p>
                        <ul class="list-inline social-buttons" data-aos="zoom-in" data-aos-duration="950">
                            <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fa fa-linkedin"></i></a></li>
    ...
    <section id="contact" style="background-image:url('assets/img/map-image.png');">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="contactForm" name="contactForm" novalidate="novalidate" method="post">
                        <div class="form-row">
                            <div class="col col-md-6">
                                ...
                                <div class="form-group"><input class="form-control" type="tel" placeholder="Your Phone *" required="" name="tel"><small class="form-text text-danger help-block lead"></small></div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"><button class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" type="submit" name="button">Send Message</button></div>
                        </div>
                    </form>
                </div>
            </div>
...
<?php require_once("./assets/other/footer.php");?>
